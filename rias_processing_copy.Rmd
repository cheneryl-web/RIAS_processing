...
#replace 0 with NA
rias_prof<-rias_prof%>%
  subset(select = c(`prof002`:`prof009`, id)) %>% 
  mutate_at(vars(`prof002`:`prof009`),  as.character)%>%
  mutate_at(vars(`prof002`:`prof009`),  replace_na, "0")%>%
  mutate_at(vars(`prof002`:`prof009`),  as.numeric)
...
rias_prof_d <- rias_prof %>% 
  ...
  mutate_at(vars(`prof002`:`prof009`),  as.character)%>%
  mutate_at(vars(`prof002`:`prof009`),  replace_na, "0")%>%
  mutate_at(vars(`prof002`:`prof009`),  as.factor)%>%
  mutate_at(vars(`prof002`:`prof009`), funs(dplyr::recode(.,"0" = 0, .default = 1)))
